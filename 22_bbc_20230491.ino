...
//#define _DUTY_MAX 1947 // 2000
#define _DUTY_MAX 1900
#define _DUTY_NEU 1400 // 1500
#define _DUTY_MIN 412 // 1000

#define _SERVO_ANGLE_DIFF  96  // Replace with |D - E| degree
#define _SERVO_SPEED       220  // servo speed

#define _BANGBANG_RANGE    700  // duty up and down for bangbang control
...
void loop()
{
  ...
  if (event_dist) {
    ...
    dist_filtered = volt_to_distance(ir_sensor_filtered(1, 0.5, 0));
...
float volt_to_distance(int x)
{
  ...
  return 752 + -2.72*x + 2.43E-03*x*x;
}
